...
add_definitions(-DEXTRADEFINES -DUSE_CONVARS -DVOICE_OVER_IP -DBUMPMAP -D__USEA3D -D_ADD_EAX_ -DENGINE_DLL -DVERSION_SAFE_STEAM_API_INTERFACES -DPROTECTED_THINGS_ENABLE -DUSE_BREAKPAD_HANDLER -DINCLUDE_SCALEFORM)
...
vpc_file(SRC_FILES
    "${ESRCDIR}/cl_rcon.cpp" NOT DEDICATED
    "${ESRCDIR}/rpt_engine.cpp" NOT DEDICATED
    "${ESRCDIR}/cl_steamauth.cpp" NOT DEDICATED
    "${ESRCDIR}/clientframe.cpp"
    "${ESRCDIR}/decal_clip.cpp"
    "${ESRCDIR}/demofile.cpp"
    "${ESRCDIR}/demostreamhttp.cpp"
    "${ESRCDIR}/demostream.cpp"
    "${ESRCDIR}/demobuffer.cpp"
    "${ESRCDIR}/DevShotGenerator.cpp"
    "${ESRCDIR}/OcclusionSystem.cpp"
    "${ESRCDIR}/tmessage.cpp"
    "${ESRCDIR}/r_efx.cpp" NOT DEDICATED
    "${ESRCDIR}/view.cpp"
    "${SRCDIR}/game/shared/cstrike15/dlchelper.h"
    "${ESRCDIR}/baseclientstate.cpp"
    "${ESRCDIR}/console.cpp"
    "${ESRCDIR}/cl_demoactioneditors.cpp" NOT DEDICATED
    "${ESRCDIR}/cl_demoactionmanager.cpp" NOT DEDICATED
    "${ESRCDIR}/cdll_engine_int.cpp" NOT DEDICATED
    "${ESRCDIR}/cbenchmark.cpp" NOT DEDICATED
    "${ESRCDIR}/cl_null.cpp" DEDICATED
    "${ESRCDIR}/brushbatchrender.cpp" DEDICATED
    "${ESRCDIR}/cl_bounded_cvars.cpp" NOT DEDICATED
    "${ESRCDIR}/LoadScreenUpdate.cpp" NOT DEDICATED
    "${ESRCDIR}/lightcache.cpp" NOT DEDICATED
    "${ESRCDIR}/bugreporter.cpp" NOT DEDICATED
)
